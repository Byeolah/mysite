...
urlpatterns = [
    ...
    path('mytrips/<int:trip_id>/ticket/', views.ticketlist, name='ticketList'),
    path('mytrips/<int:trip_id>/ticket/<int:ticket_id>/', views.ticketview, name='ticketView'),
    path('mytrips/<int:trip_id>/ticket/add/', views.ticketadd, name='ticketAdd'),
    path('mytrips/<int:trip_id>/ticket/<int:ticket_id>/edit/', views.ticketedit, name='ticketEdit'),
    path('mytrips/<int:trip_id>/ticket/<int:ticket_id>/delete/', views.ticketdelete, name='ticketDelete'),
